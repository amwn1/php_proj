<?php 
  ...
  if(isset($_GET)){
    foreach($_GET as $key=>$val){
      $u = mysqli_real_escape_string($conn, $key);  // Saniization purposes , making 
      $new_url = str_replace('/', '', $u); // just to make it user friendly
    }
      ...
      if(mysqli_num_rows($sql2) > 0){;
        ?>
          <div class="statistics">
            ...
            ?>
            <span>Total Links: <span><?php echo end($res) ?></span> & Total Clicks: <span>1<?php echo $total ?></span></span>
